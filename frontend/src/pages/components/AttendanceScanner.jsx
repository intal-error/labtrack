...
export default function AttendanceScanner() {
  ...
  return (
    <>
      {/* Mode Toggle — uses shared scanner-mode classes */}
      <div className="scanner-mode">
        <button
          className={`scanner-mode-btn ${isTimeIn ? "active" : ""}`}
        ...
        <button
          className={`scanner-mode-btn time-out ${!isTimeIn ? "active" : ""}`}
      ...
      {/* Status Banner — uses shared scanner-status-banner */}
      {txStatus && (
